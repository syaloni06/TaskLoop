...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5100/login', {
                email,
                password
            });
...
_s(LoginPage, "d64XXIT6mwpG/5Tm9MWjxxU1N6k=", false, function() {
    return [
...
//# sourceMappingURL=src_app_83cedeb4._.js.map