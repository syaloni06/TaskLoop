...
function RegisterPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('http://localhost:5100/register', {
                name,
                email,
                password
            });
...
_s(RegisterPage, "HQaui9WnFucNeaZpBGO8IJcnCL4=", false, function() {
    return [
...
//# sourceMappingURL=src_app_323a3f8d._.js.map