...
function TaskForm({ onSuccess }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TaskForm.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/api/users').then({
                "TaskForm.useEffect": (res)=>setUsers(res.data)
            }["TaskForm.useEffect"]);
        }
    }["TaskForm.useEffect"], []);
    const onSubmit = async (data)=>{
        await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/api/tasks', data);
        reset();
        onSuccess();
    };
...
_s(TaskForm, "Gyn5xv940VakZENydbVevjcmOGY=", false, function() {
    return [
...
_s(TasksPage, "przLs5VUwW7EbtbpTa/2S55f8DU=");
_c = TasksPage;
var _c;
...
//# sourceMappingURL=src_app_25500e8a._.js.map